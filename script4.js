...
var guessTracker = function(){
  ...
  $('#guesses-remaining').text(8 - guessNum);
...
var giveHint = function(){
  ...
  alert("Here's a hint...the number is somewhere in the " + hintNum);
};
...
{
window.location.href='https://raeannaeudy.github.io/spookyescape/puzzle5.html';
};
}