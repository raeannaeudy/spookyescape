...
function openWinModal() {
  ...
  $(".modal-body").html(
    `You completed the game in ${times} . <br></br> You used ${move} moves. <br></br> You get ${rating} stars. <a href="https://raeannaeudy.github.io/spookyescape/congrats.html">congrats</a>`
  );
